...
{
    public partial class StartPageFriendsRecentUnlocksGridView : UserControl
    {
        private DataGridRow _pendingRightClickRow;

        public StartPageFriendsRecentUnlocksGridView()
        {
            InitializeComponent();
        }
        ...
        private bool OpenContextMenuForRow(DataGridRow row)
        {
            ...
            ContextMenuStyleHelper.ApplyAchievementContextMenuStyle(FriendsRecentUnlocksGrid, menu);
        ...
        private void RefreshAfterRowOptionsChanged()
        {
            ...
            FriendsRecentUnlocksGrid?.Refresh();
        }
    }
}
