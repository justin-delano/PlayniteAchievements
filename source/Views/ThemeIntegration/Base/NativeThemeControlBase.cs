...
{
    /// <summary>
    /// Base class for Native theme integration controls.
    /// Provides common initialization and game context change handling for Native achievement controls.
    /// </summary>
    public abstract class NativeThemeControlBase : PluginUserControl
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NativeThemeControlBase"/> class.
        ...
        /// </exception>
        protected NativeThemeControlBase()
        {
