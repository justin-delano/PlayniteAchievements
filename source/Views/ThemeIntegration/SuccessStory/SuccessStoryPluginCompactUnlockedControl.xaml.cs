...
namespace PlayniteAchievements.Views.ThemeIntegration.SuccessStory
{
    ...
    /// </summary>
    public partial class SuccessStoryPluginCompactUnlockedControl : CompactAchievementControlBase
    {
        protected override Grid CompactViewGrid => PART_ScCompactView;

        public SuccessStoryPluginCompactUnlockedControl()
        {
            InitializeComponent();
            DataContext = this;
        }
        ...
        {
            var source = Plugin?.Settings?.SuccessStoryTheme?.ListAchUnlockDateDesc;
        ...
        protected override int GetTotalCount()
        {
            ...
            return Plugin?.Settings?.SuccessStoryTheme?.Unlocked ?? 0;
        }
        ...
        protected override string[] GetSettingsPropertyNames()
        {
            return new[]
            {
                nameof(SuccessStoryThemeData.ListAchUnlockDateDesc),
                nameof(SuccessStoryThemeData.ListAchievements),
                nameof(SuccessStoryThemeData.Unlocked)
            };
        }
