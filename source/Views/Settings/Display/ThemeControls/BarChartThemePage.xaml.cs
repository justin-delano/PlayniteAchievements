...
{
    /// <summary>
    /// Display settings: Bar Chart theme control page (enable toggle and preview).
    /// </summary>
    public partial class BarChartThemePage : UserControl
    {
        private readonly ThemeControlPreviewState _preview;

        public BarChartThemePage()
        {
            InitializeComponent();
        }

        internal BarChartThemePage(ThemeControlPreviewState preview)
            : this()
        {
