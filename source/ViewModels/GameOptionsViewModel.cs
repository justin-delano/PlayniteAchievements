...
namespace PlayniteAchievements.ViewModels
{
    public sealed class GameOptionsViewModel : PlayniteAchievements.Common.ObservableObject
    {
        ...
        private string _localFolderOverrideValue;
        private string _localFolderOverrideInput;
        ...
        private string _xeniaTitleIdOverrideInput;
        private bool _showShadPS4MatchIdOverride;
        private bool _hasShadPS4MatchIdOverride;
        private string _shadPS4MatchIdOverrideValue;
        private string _shadPS4MatchIdOverrideInput;
        ...
        public bool ShowXeniaTitleIdOverride
        {
            get => _showXeniaTitleIdOverride;
            private set
            {
                if (SetValueAndReturn(ref _showXeniaTitleIdOverride, value))
                {
                    RaiseCommandStates();
                }
            }
        ...
        public string RaOverrideValue
        {
            ...
            private set
            {
                if (SetValueAndReturn(ref _raOverrideValue, value))
                {
                    OnPropertyChanged(nameof(RaStatusText));
                }
            }
        ...
        public bool HasLocalSteamAppIdOverride
        {
            get => _hasLocalSteamAppIdOverride;
            private set
            {
                if (SetValueAndReturn(ref _hasLocalSteamAppIdOverride, value))
                {
                    OnPropertyChanged(nameof(LocalSteamAppIdStatusText));
                    RaiseCommandStates();
                }
            }
        }

        public string LocalSteamAppIdOverrideValue
        {
            get => _localSteamAppIdOverrideValue;
            private set => SetValue(ref _localSteamAppIdOverrideValue, value);
        }

        public string LocalSteamAppIdOverrideInput
        {
            get => _localSteamAppIdOverrideInput;
            set
            {
                if (SetValueAndReturn(ref _localSteamAppIdOverrideInput, value ?? string.Empty))
                {
                    RaiseCommandStates();
                }
            }
        ...
        public string LocalSteamAppIdStatusText
        {
            get
            {
                if (!HasLocalSteamAppIdOverride)
                {
                    return L("LOCPlayAch_GameOptions_Status_LocalSteamAppIdOverrideNone", "No forced Steam App ID set");
                }
        ...
        public IReadOnlyList<LocalSteamAppCacheUserOption> AvailableLocalSteamAppCacheUsers
        {
            ...
            private set => SetValue(ref _availableLocalSteamAppCacheUsers, value ?? Array.Empty<LocalSteamAppCacheUserOption>());
        }

        public bool HasLocalSteamAppCacheUserOverride
        {
            get => _hasLocalSteamAppCacheUserOverride;
            private set
            {
                if (SetValueAndReturn(ref _hasLocalSteamAppCacheUserOverride, value))
                {
                    OnPropertyChanged(nameof(LocalSteamAppCacheUserStatusText));
                    RaiseCommandStates();
                }
            }
        }

        public string LocalSteamAppCacheUserOverrideValue
        {
            get => _localSteamAppCacheUserOverrideValue;
            private set => SetValue(ref _localSteamAppCacheUserOverrideValue, value);
        }

        public string LocalSteamAppCacheUserOverrideInput
        {
            get => _localSteamAppCacheUserOverrideInput;
            set
            {
                if (SetValueAndReturn(ref _localSteamAppCacheUserOverrideInput, value ?? string.Empty))
                {
                    OnPropertyChanged(nameof(LocalSteamAppCacheUserStatusText));
                    RaiseCommandStates();
                }
        ...
        public string LocalSteamAppCacheUserStatusText
        {
            get
            {
                if (!HasLocalSteamAppCacheUserOverride)
                {
                    return L("LOCPlayAch_GameOptions_Status_LocalSteamUserOverrideNone", "Automatic Steam user detection");
                }

                return string.Format(
                    L("LOCPlayAch_GameOptions_Status_LocalSteamUserOverrideValue", "Forced Steam user: {0}"),
                    GetSteamUserDisplayName(LocalSteamAppCacheUserOverrideValue));
            }
        }

        public bool HasLocalFolderOverride
        {
            get => _hasLocalFolderOverride;
            private set
            {
                if (SetValueAndReturn(ref _hasLocalFolderOverride, value))
                {
                    OnPropertyChanged(nameof(LocalFolderStatusText));
                    RaiseCommandStates();
                }
            }
        }

        public string LocalFolderOverrideValue
        {
            get => _localFolderOverrideValue;
            private set => SetValue(ref _localFolderOverrideValue, value);
        }

        public string LocalFolderOverrideInput
        {
            get => _localFolderOverrideInput;
            set
            {
                if (SetValueAndReturn(ref _localFolderOverrideInput, value ?? string.Empty))
                {
                    RaiseCommandStates();
                }
            }
        ...
        public string LocalFolderAutoPath
        {
            get => _localFolderAutoPath;
            private set
            {
                if (SetValueAndReturn(ref _localFolderAutoPath, value))
                {
                    OnPropertyChanged(nameof(LocalFolderStatusText));
                }
            }
        ...
        {
            get => _hasAmbiguousLocalFolders;
            private set
            {
                if (SetValueAndReturn(ref _hasAmbiguousLocalFolders, value))
                {
                    OnPropertyChanged(nameof(LocalFolderStatusText));
                }
            }
        ...
        public string LocalFolderStatusText
        {
            get
            {
                ...
                {
                    return string.Format(
                        L("LOCPlayAch_GameOptions_Status_LocalFolderOverrideValue", "Forced folder: {0}"),
                        LocalFolderOverrideValue);
                }

                if (!string.IsNullOrWhiteSpace(LocalFolderAutoPath))
                {
                    return HasAmbiguousLocalFolders
                        ? string.Format(
                            L("LOCPlayAch_GameOptions_Status_LocalFolderAmbiguous", "Multiple local folders found. Using: {0}"),
                            LocalFolderAutoPath)
                        : string.Format(
                            L("LOCPlayAch_GameOptions_Status_LocalFolderAuto", "Auto-detected folder: {0}"),
                            LocalFolderAutoPath);
                }
        ...
        public bool ShowShadPS4MatchIdOverride
        {
            ...
            private set
            {
                if (SetValueAndReturn(ref _showShadPS4MatchIdOverride, value))
                {
                    RaiseCommandStates();
                }
            }
        ...
        public bool HasXeniaTitleIdOverride
        {
            get => _hasXeniaTitleIdOverride;
            private set
            {
                if (SetValueAndReturn(ref _hasXeniaTitleIdOverride, value))
                {
                    OnPropertyChanged(nameof(XeniaTitleIdStatusText));
                    RaiseCommandStates();
                }
            }
        }

        public string XeniaTitleIdOverrideValue
        {
            get => _xeniaTitleIdOverrideValue;
            private set
            {
                if (SetValueAndReturn(ref _xeniaTitleIdOverrideValue, value))
                {
                    OnPropertyChanged(nameof(XeniaTitleIdStatusText));
                }
            }
        ...
        public string XeniaTitleIdOverrideInput
        {
            get => _xeniaTitleIdOverrideInput;
            set
            {
                if (SetValueAndReturn(ref _xeniaTitleIdOverrideInput, value ?? string.Empty))
                {
                    RaiseCommandStates();
                }
            }
        ...
        public string XeniaTitleIdStatusText => !HasXeniaTitleIdOverride
            ? L("LOCPlayAch_Common_Status_NoOverrideSet", "No override set")
            : string.Format(
                L("LOCPlayAch_Common_Status_OverrideSetValue", "Override set: {0}"),
                XeniaTitleIdOverrideValue);

        public bool HasShadPS4MatchIdOverride
        {
            get => _hasShadPS4MatchIdOverride;
            private set
            {
                if (SetValueAndReturn(ref _hasShadPS4MatchIdOverride, value))
                {
                    OnPropertyChanged(nameof(ShadPS4MatchIdStatusText));
                    RaiseCommandStates();
                }
            }
        }

        public string ShadPS4MatchIdOverrideValue
        {
            get => _shadPS4MatchIdOverrideValue;
            private set
            {
                if (SetValueAndReturn(ref _shadPS4MatchIdOverrideValue, value))
                {
                    OnPropertyChanged(nameof(ShadPS4MatchIdStatusText));
                }
            }
        ...
        public string ShadPS4MatchIdOverrideInput
        {
            get => _shadPS4MatchIdOverrideInput;
            set
            {
                if (SetValueAndReturn(ref _shadPS4MatchIdOverrideInput, value ?? string.Empty))
                {
                    RaiseCommandStates();
                }
            }
        ...
        public string ShadPS4MatchIdStatusText => !HasShadPS4MatchIdOverride
            ? L("LOCPlayAch_Common_Status_NoOverrideSet", "No override set")
            : string.Format(
                L("LOCPlayAch_Common_Status_OverrideSetValue", "Override set: {0}"),
                ShadPS4MatchIdOverrideValue);
        ...
        public void Reload()
        {
            try
            {
                ...
                TotalAchievements = list.Count > 0 ? list.Count : (gameData?.AchievementCount ?? 0);
                UnlockedAchievements = list.Count > 0 ? list.Count(a => a.Unlocked) : (gameData?.UnlockedCount ?? 0);
                ...
                if (LocalSavesProvider.TryGetAppIdOverride(_gameId, out var localSteamAppId))
                {
                    HasLocalSteamAppIdOverride = true;
                    LocalSteamAppIdOverrideValue = localSteamAppId.ToString();
                    LocalSteamAppIdOverrideInput = LocalSteamAppIdOverrideValue;
                }
                else
                {
                    HasLocalSteamAppIdOverride = false;
                    LocalSteamAppIdOverrideValue = string.Empty;
                ...
                {
                    new LocalSteamAppCacheUserOption(string.Empty, L("LOCPlayAch_GameOptions_LocalSteamUser_Automatic", "Automatic (all detected users)"))
                };
                if (localProvider != null)
                {
                    availableSteamUsers.AddRange(localProvider.GetAvailableSteamAppCacheUsers());
                }
                AvailableLocalSteamAppCacheUsers = availableSteamUsers;

                if (LocalSavesProvider.TryGetSteamAppCacheUserOverride(_gameId, out var localSteamUserOverride))
                {
                    if (!AvailableLocalSteamAppCacheUsers.Any(option => string.Equals(option.UserId, localSteamUserOverride, StringComparison.OrdinalIgnoreCase)))
                    {
                        AvailableLocalSteamAppCacheUsers = AvailableLocalSteamAppCacheUsers
                            .Concat(new[] { new LocalSteamAppCacheUserOption(localSteamUserOverride, localSteamUserOverride) })
                            .ToList();
                    }

                    HasLocalSteamAppCacheUserOverride = true;
                    LocalSteamAppCacheUserOverrideValue = localSteamUserOverride;
                    LocalSteamAppCacheUserOverrideInput = localSteamUserOverride;
                }
                else
                {
                    HasLocalSteamAppCacheUserOverride = false;
                    LocalSteamAppCacheUserOverrideValue = string.Empty;
                    LocalSteamAppCacheUserOverrideInput = string.Empty;
                }

                if (localProvider != null && localProvider.TryGetResolvedFolderInfo(game, out var selectedFolder, out var candidateFolders, out var isFolderOverridden, out var isAmbiguousFolder))
                {
                    HasLocalFolderOverride = isFolderOverridden;
                    LocalFolderOverrideValue = isFolderOverridden ? selectedFolder : string.Empty;
                ...
                {
                    HasLocalFolderOverride = true;
                    LocalFolderOverrideValue = overriddenFolder;
                ...
                {
                    HasLocalFolderOverride = false;
                    LocalFolderOverrideValue = string.Empty;
                ...
                {
                    HasXeniaTitleIdOverride = true;
                    XeniaTitleIdOverrideValue = xeniaTitleIdOverride;
                    XeniaTitleIdOverrideInput = xeniaTitleIdOverride;
                }
                else
                {
                    HasXeniaTitleIdOverride = false;
                    XeniaTitleIdOverrideValue = string.Empty;
                    XeniaTitleIdOverrideInput = string.Empty;
                }

                ShowXeniaTitleIdOverride = HasXeniaTitleIdOverride ||
                    string.IsNullOrWhiteSpace(effectiveProviderKey) ||
                    string.Equals(effectiveProviderKey, "Xenia", StringComparison.OrdinalIgnoreCase);

                if (ShadPS4DataProvider.TryGetMatchIdOverride(_gameId, out var shadPS4MatchIdOverride))
                {
                    HasShadPS4MatchIdOverride = true;
                    ShadPS4MatchIdOverrideValue = shadPS4MatchIdOverride;
                    ShadPS4MatchIdOverrideInput = shadPS4MatchIdOverride;
                }
                else
                {
                    HasShadPS4MatchIdOverride = false;
                    ShadPS4MatchIdOverrideValue = string.Empty;
                    ShadPS4MatchIdOverrideInput = string.Empty;
                }

                ShowShadPS4MatchIdOverride = HasShadPS4MatchIdOverride ||
                    string.IsNullOrWhiteSpace(effectiveProviderKey) ||
                    string.Equals(effectiveProviderKey, "ShadPS4", StringComparison.OrdinalIgnoreCase);
        ...
        private void ApplyLocalSteamAppIdOverride()
        {
            var text = (LocalSteamAppIdOverrideInput ?? string.Empty).Trim();
            if (!int.TryParse(text, out var newId) || newId <= 0)
            {
                _playniteApi?.Dialogs?.ShowMessage(
                    L("LOCPlayAch_Menu_LocalAppId_InvalidId", "Please enter a valid positive Steam App ID."),
                    L("LOCPlayAch_Title_PluginName", "Playnite Achievements"),
                    MessageBoxButton.OK,
            ...
            if (TrySetLocalSteamAppIdOverride(newId))
            {
                Reload();
            }
        }
        ...
        {
            var selectedUserId = (LocalSteamAppCacheUserOverrideInput ?? string.Empty).Trim();
            if (string.IsNullOrWhiteSpace(selectedUserId))
            {
                if (TryClearLocalSteamAppCacheUserOverride())
                {
                    Reload();
                }
            ...
            if (TrySetLocalSteamAppCacheUserOverride(selectedUserId))
            {
                Reload();
            }
        }

        private void ClearLocalSteamAppCacheUserOverride()
        {
            if (TryClearLocalSteamAppCacheUserOverride())
            {
                Reload();
        ...
        private void ApplyLocalFolderOverride()
        {
            var text = (LocalFolderOverrideInput ?? string.Empty).Trim();
            if (string.IsNullOrWhiteSpace(text))
            {
                _playniteApi?.Dialogs?.ShowMessage(
                    L("LOCPlayAch_GameOptions_LocalFolder_Invalid", "Please enter a valid local folder path."),
                    L("LOCPlayAch_Title_PluginName", "Playnite Achievements"),
                    MessageBoxButton.OK,
                    MessageBoxImage.Warning);
                return;
            ...
            {
                _playniteApi?.Dialogs?.ShowMessage(
                    L("LOCPlayAch_GameOptions_LocalFolder_NotFound", "The selected local folder does not exist."),
                    L("LOCPlayAch_Title_PluginName", "Playnite Achievements"),
                    MessageBoxButton.OK,
                    MessageBoxImage.Warning);
                return;
            ...
            if (TrySetLocalFolderOverride(text))
            {
                Reload();
            }
        }

        private void ClearLocalFolderOverride()
        {
            if (TryClearLocalFolderOverride())
            {
                Reload();
            }
        }

        private void BrowseLocalFolderOverride()
        {
        ...
        {
            var text = (XeniaTitleIdOverrideInput ?? string.Empty).Trim();
            if (!XeniaTitleIdHelper.TryNormalize(text, out var normalizedTitleId))
            {
                _playniteApi?.Dialogs?.ShowMessage(
                    L("LOCPlayAch_Menu_XeniaTitleId_InvalidId", "Please enter a valid 8-character hexadecimal Xenia TitleID."),
                    L("LOCPlayAch_Title_PluginName", "Playnite Achievements"),
                    System.Windows.MessageBoxButton.OK,
                    System.Windows.MessageBoxImage.Warning);
                return;
            ...
            if (TrySetXeniaTitleIdOverride(normalizedTitleId))
            {
                Reload();
            }
        }

        private void ApplyShadPS4MatchIdOverride()
        {
            var text = (ShadPS4MatchIdOverrideInput ?? string.Empty).Trim();
            if (!ShadPS4MatchIdHelper.TryNormalize(text, out var normalizedMatchId))
            {
                _playniteApi?.Dialogs?.ShowMessage(
                    L("LOCPlayAch_Menu_ShadPS4MatchId_InvalidId", "Please enter a valid ShadPS4 match ID such as CUSA00432 or NPWR12345_00."),
                    L("LOCPlayAch_Title_PluginName", "Playnite Achievements"),
                    System.Windows.MessageBoxButton.OK,
                    System.Windows.MessageBoxImage.Warning);
                return;
            ...
            if (TrySetShadPS4MatchIdOverride(normalizedMatchId))
            {
                Reload();
            }
        }
        ...
        private void ClearXeniaTitleIdOverride()
        {
            if (TryClearXeniaTitleIdOverride())
            {
                Reload();
            }
        }

        private void ClearShadPS4MatchIdOverride()
        {
            if (TryClearShadPS4MatchIdOverride())
            {
                Reload();
            }
        }
        ...
        private bool TrySetLocalSteamAppIdOverride(int newId)
        {
            ...
            if (!LocalSavesProvider.TrySetAppIdOverride(_gameId, newId, game.Name, _persistSettingsForUi, _logger))
            {
                return false;
            }
        ...
        private bool TryClearLocalSteamAppIdOverride()
        {
            var game = _playniteApi?.Database?.Games?.Get(_gameId);
            if (game == null)
            {
            ...
            if (!LocalSavesProvider.TryClearAppIdOverride(_gameId, game.Name, _persistSettingsForUi, _logger))
            {
                return false;
            }
        ...
        {
            var game = _playniteApi?.Database?.Games?.Get(_gameId);
            if (game == null || string.IsNullOrWhiteSpace(userId))
            {
                return false;
            }

            if (!LocalSavesProvider.TrySetSteamAppCacheUserOverride(_gameId, userId, game.Name, _persistSettingsForUi, _logger))
            {
                return false;
            }
        ...
        private bool TryClearLocalSteamAppCacheUserOverride()
        {
            var game = _playniteApi?.Database?.Games?.Get(_gameId);
            if (game == null)
            {
            ...
            if (!LocalSavesProvider.TryClearSteamAppCacheUserOverride(_gameId, game.Name, _persistSettingsForUi, _logger))
            {
                return false;
            }
        ...
        private string GetSteamUserDisplayName(string userId)
        {
            var normalizedUserId = (userId ?? string.Empty).Trim();
            if (string.IsNullOrWhiteSpace(normalizedUserId))
            {
                return L("LOCPlayAch_GameOptions_LocalSteamUser_Automatic", "Automatic (all detected users)");
            }
        ...
        {
            var game = _playniteApi?.Database?.Games?.Get(_gameId);
            if (game == null || string.IsNullOrWhiteSpace(titleId))
            {
                return false;
            }

            if (!XeniaDataProvider.TrySetTitleIdOverride(_gameId, titleId, game.Name, _persistSettingsForUi, _logger))
            {
                return false;
            }
        ...
        private bool TryClearXeniaTitleIdOverride()
        {
            var game = _playniteApi?.Database?.Games?.Get(_gameId);
            if (game == null)
            {
            ...
            if (!XeniaDataProvider.TryClearTitleIdOverride(_gameId, game.Name, _persistSettingsForUi, _logger))
            {
                return false;
            }
        ...
        private bool TrySetLocalFolderOverride(string folderPath)
        {
            var game = _playniteApi?.Database?.Games?.Get(_gameId);
            if (game == null || string.IsNullOrWhiteSpace(folderPath))
            {
                return false;
            }

            if (!LocalSavesProvider.TrySetFolderOverride(_gameId, folderPath, game.Name, _persistSettingsForUi, _logger))
            {
                return false;
            }
        ...
        {
            var game = _playniteApi?.Database?.Games?.Get(_gameId);
            if (game == null || string.IsNullOrWhiteSpace(matchId))
            {
                return false;
            }

            if (!ShadPS4DataProvider.TrySetMatchIdOverride(_gameId, matchId, game.Name, _persistSettingsForUi, _logger))
            {
                return false;
            }
        ...
        private bool TryClearShadPS4MatchIdOverride()
        {
            var game = _playniteApi?.Database?.Games?.Get(_gameId);
            if (game == null)
            {
            ...
            if (!ShadPS4DataProvider.TryClearMatchIdOverride(_gameId, game.Name, _persistSettingsForUi, _logger))
            {
                return false;
            }
