    ...
    public sealed class GameOptionsViewModel : ObservableObject
    {
        ...
        public bool UseExophaseForGame
        {
            ...
            set
            {
                if (SetValueAndReturn(ref _useExophaseForGame, value))
                {
                    ...
                    var exophaseSettings = _settings.ProviderSettings<ExophaseSettings>();
                    if (value)
                    {
                    ...
                    {
                        if (exophaseSettings.IncludedGames.Remove(_gameId))
                        {
        ...
        public void Reload()
        {
            try
            {
                ...
                var allowManualOverride = _settings?.ProviderSettings<ManualSettings>().ManualTrackingOverrideEnabled;
                ...
                if (exophaseEnabled && game != null)
                {
                    ...
                    UseExophaseForGame = exophaseSettings.IncludedGames.Contains(_gameId);
                    ...
                    var hasSlugOverride = exophaseSettings.SlugOverrides.TryGetValue(_gameId, out var overrideSlug);
        ...
        private bool TrySetXeniaOverride(string newTitleId)
        {
            ...
            var xeniaSettings = _settings.ProviderSettings<XeniaSettings>();
